...
public class phaseoneproject {
	...
	public static void main(String[] args) {
		...
		System.out.println("The developer of this page is "+ "Naga srinivasareddy");
		...
		File file1 = new File("main\\folder1");
		...
		File file2 = new File("main\\folder2");
